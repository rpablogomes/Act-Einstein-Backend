...
describe('InterviewedController', () => {
  ...
  const mockInterviewedService = {
    ...
    findAll: jest.fn(() => Promise.resolve([{ id: 1, name: 'Test Interviewed' }])),
  ...
  //     const dto: CreateInterviewedDto = { name: 'New Interviewed' };
  ...
  describe('findAll', () => {
    it('should return an array of interviewed entities', async () => {
      expect(await controller.findAll()).toEqual([{ id: 1, name: 'Test Interviewed' }]);
  ...
  describe('findOne', () => {
    it('should return a single interviewed entity by ID', async () => {
      const id = 1;
      expect(await controller.findOne(id.toString())).toEqual({ id, name: 'Test Interviewed' });
  ...
  //     const id = 1;
  //     const dto: UpdateInterviewedDto = { name: 'Updated Interviewed' };
  //     expect(await controller.update(id.toString(), dto)).toEqual({ id, ...dto });
